...
public class ConnectionDialog extends javax.swing.JDialog {
    ...
    private DatabaseAccess createDatabaseConnection() throws ClassNotFoundException, SQLException, StringIndexOutOfBoundsException {
        if(tabbedPanesDatabaseType.getSelectedIndex() == 0)
        return new DatabaseAccess( DatabaseAccess.databaseType.ORACLE_THIN,
                                    this.textFieldIpAddress.getText(),
                                    this.textFieldPort.getText(),
                                    this.textFieldSid.getText(),
                                    this.textFieldSchema.getText(),
                                    this.passwordFieldOracle.getText());
        else
            return new DatabaseAccess( DatabaseAccess.databaseType.MYSQL,
                                        this.textFieldIpAddress.getText(),
                                        this.textFieldPort.getText(),
                                        this.textFieldDatabase.getText(),
                                        this.textFieldLogin.getText(),
                                        this.passwordFieldMysql.getText());
    }
    ...
    private void buttonTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonTestActionPerformed
        ...
        try{
            DatabaseAccess databaseAccess = createDatabaseConnection();
    ...
    private void buttonConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConnectActionPerformed
        try {
            DatabaseAccess databaseAccess = createDatabaseConnection();
            databaseAccess.connect();
            this.parent.connect(databaseAccess);
            this.setVisible(false);
            this.dispose();
        } catch (ClassNotFoundException | SQLException ex) {
            this.labelStatusMessage.setForeground(Color.RED);
