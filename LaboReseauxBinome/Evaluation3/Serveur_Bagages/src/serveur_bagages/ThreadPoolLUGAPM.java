...
public class ThreadPoolLUGAPM extends ThreadPool {
    ...
    protected Runnable getProtocolRunnable(Socket socket) throws CommunicatorException{
        return new RunnableLUGAPM(this, this.guiApplication, new Communicator(socket),
                new DatabaseAccess(DatabaseAccess.databaseType.MYSQL, this.DBip, this.DBport,
                                    this.DBSID, this.DBschema, this.DBpassword));
    }
}
