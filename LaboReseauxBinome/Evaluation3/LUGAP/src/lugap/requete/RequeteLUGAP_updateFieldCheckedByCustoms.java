...
public class RequeteLUGAP_updateFieldCheckedByCustoms extends RequeteLUGAP implements Serializable {
    private final Luggage luggage;
    private final char newValue;

    public RequeteLUGAP_updateFieldCheckedByCustoms(Luggage luggage, char newValue) {
        ...
        try {
            try {
                ...
                if(result==0){
                    ...
                    traceEvent("Field 'checkedbycustom' updated to '" + this.newValue + "' (luggage: " + this.luggage.toString() + ")");
                }
