...
public class RequeteLUGAP_updateFieldReceived extends RequeteLUGAP implements Serializable {
    private final Luggage luggage;
    private final char newValue;

    public RequeteLUGAP_updateFieldReceived(Luggage luggage, char newValue) {
        ...
        try {
            try {
                ...
                if(result==0){
                    ...
                    traceEvent("Field 'received' updated to '" + this.newValue + "' (luggage: " + this.luggage.toString() + ")");
                }
            ...
            traceEvent("UpdateFieldReceived : " + ex.getMessage());
        }
    }
}
