...
public class Requete_MAJ_ChampChargement extends ARequete implements Serializable {
    /**
     * 
     */
    ...
    public Requete_MAJ_ChampChargement(Baggage baggage, char newValue) {
        ...
        try {
            try {
                ...
                if(result==0){
                    ...
                    traceEvent("Field 'loaded' updated to '" + this.newValue + "' (luggage: " + this.baggage.toString() + ")");
                }
