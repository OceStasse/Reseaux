...
public class Requete_MAJ_ChampRecevoir extends ARequete implements Serializable {
    ...
    public Requete_MAJ_ChampRecevoir(Baggage baggage, char newValue) {
        ...
        try {
            try {
                ...
                if(result==0){
                    ...
                    traceEvent("Field 'received' updated to '" + this.newValue + "' (luggage: " + this.baggage.toString() + ")");
                }
