...
public class Requete_MAJ_ChampComment extends ARequete implements Serializable {
    ...
    public Requete_MAJ_ChampComment(Baggage baggage, String newValue) {
        ...
        try {
            try {
                ...
                if(result==0){
                    ...
                    traceEvent("Field 'comments' updated to '" + this.newValue + "' (luggage: " + this.baggage.toString() + ")");
                }
