...
public class RequeteLUGAP_updateFieldComments extends RequeteLUGAP implements Serializable {
    private final Luggage luggage;
    private final String newValue;

    public RequeteLUGAP_updateFieldComments(Luggage luggage, String newValue) {
    ...
    protected void doAction() {
        ...
        statementMap.put(1, this.newValue);
        ...
        try {
            try {
                ...
                if(result==0){
                    ...
                    traceEvent("Field 'comments' updated to '" + this.newValue + "' (luggage: " + this.luggage.toString() + ")");
                }
            ...
            traceEvent("UpdateFieldComments : " + ex.getMessage());
        }
    }
}
